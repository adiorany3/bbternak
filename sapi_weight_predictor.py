...
with guide_tab2:
    ...
    with col1:
        ...
        """)
    with col2:
        st.image("panjangbadan.png", caption="Cara mengukur panjang badan ternak, ref : https://vetmedicinae.com/cara-menghitung-berat-badan-sapi/", use_container_width=True)
